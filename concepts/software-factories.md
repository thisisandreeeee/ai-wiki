...
## Mid-September 2026: field context and persistent handoffs

The FDE account gives software factories a customer-facing operating loop: observe production reality, collect the customer’s nouns and verbs, fix the immediate gap, and return the reusable lesson to the platform. A local workaround that never becomes a product is consulting, not a compounding factory. [[forward-deployed-engineering]] develops this distinction. [raw/newsletters/latent-space-2026-09-12-the-rise-of-the-forward-deployed-engineer-and-how-to-do-the-job-right.md]
